...
5. Results stream back as structured events. The session posts them to the daemon, which is the only writer of `history.sqlite`, and fans them out to whoever is attached.
