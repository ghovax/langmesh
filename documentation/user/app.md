...
The tool reads the accessibility tree and the page's structure, not screenshots. See [Tools](agent-system.md#screen-control-control_screen) for what it can and cannot do.
