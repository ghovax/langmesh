...
- [GitHub mentions](../user/github.md) is the library running in a GitHub Action when someone writes `@langmesh`. `LANGMESH_MODEL` is `provider/model`; templates live in `src/langmesh/github/prompts/`.
