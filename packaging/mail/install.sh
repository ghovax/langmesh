...
write_env_file() {
  ...
  if [[ -n "${LANGMESH_MAIL_ENV:-}" && -f "${LANGMESH_MAIL_ENV}" ]]; then
    cp "${LANGMESH_MAIL_ENV}" "${env_file}"
    chmod 600 "${env_file}"
    log "installed ${env_file} from ${LANGMESH_MAIL_ENV}"
    return
  fi
...
LANGMESH_MAIL_IMAP_PORT=${LANGMESH_MAIL_IMAP_PORT:-}
LANGMESH_MAIL_IMAP_SSL=${LANGMESH_MAIL_IMAP_SSL:-}
LANGMESH_MAIL_IMAP_MAILBOX=${LANGMESH_MAIL_IMAP_MAILBOX:-}
...
LANGMESH_MAIL_SMTP_PORT=${LANGMESH_MAIL_SMTP_PORT:-}
LANGMESH_MAIL_SMTP_STARTTLS=${LANGMESH_MAIL_SMTP_STARTTLS:-}
LANGMESH_MAIL_SMTP_USE_TLS=${LANGMESH_MAIL_SMTP_USE_TLS:-}
