...
export function reportError(site: FaultSite, error: unknown, detail: FaultDetail = {}): void {
...
/** A failure that is a normal outcome here, silent by design, with `reason` recording that it was considered. */
export function expected(_reason: string, _error?: unknown): void {
